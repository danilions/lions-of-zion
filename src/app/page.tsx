...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-black">
      ...
      {showSplash && (
        <SplashScreen duration={3500} onComplete={() => setShowSplash(false)} />
      )}
      ...
      <div
        className={`relative z-10 flex flex-col items-center justify-center min-h-screen max-h-screen px-4 sm:px-6 lg:px-8 transition-opacity duration-1000 ${pageLoaded ? "opacity-100" : "opacity-0"}`}
      >
        <Hero />
      </div>
