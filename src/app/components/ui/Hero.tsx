...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const timers = [
      setTimeout(
        () => setAnimateElements((prev) => ({ ...prev, title: true })),
        800,
      ),
      setTimeout(
        () => setAnimateElements((prev) => ({ ...prev, subtitle: true })),
        1400,
      ),
      setTimeout(
        () => setAnimateElements((prev) => ({ ...prev, mission: true })),
        2000,
      ),
      setTimeout(
        () => setAnimateElements((prev) => ({ ...prev, button: true })),
        2600,
      ),
    ];
