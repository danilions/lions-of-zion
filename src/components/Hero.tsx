    ...
    <div className="text-center space-y-6 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-3xl mx-auto pt-4">
        <p className="text-body text-base sm:text-lg md:text-xl leading-relaxed font-medium">
          We are the guardians of truth in an age of deception. Our mission is to cut through the noise, 
          expose the lies that divide us, and defend the authentic narratives that unite humanity. 
          Join us as we monitor the global pulse of information and stand as lions against the forces of misinformation.
        </p>
      </div>
    </div>
  );
